...
async function createTables() {
  try {
    ...
    await pool.query(
      "CREATE table patient (id uuid PRIMARY KEY uuid_generate_v4 (), name VARCHAR ( 255 ) NOT NULL,email text UNIQUE NOT NULL ,Age VARCHAR ( 50 ) NOT NULL, Sex VARCHAR ( 50 ) NOT NULL, Smoker BOOLEAN NOT NULL Default FALSE, CigsPerDay INT NOT NULL DEFAULT 0, PrevalentStroke BOOLEAN NOT NULL DEFAULT FALSE, Diabetes BOOLEAN NOT NULL DEFAULT FALSE)"
    );
